    ...
    return queryInterface.bulkInsert(
      ...
      [
        ...
        // 13
        {
          ...
          description:
            "A prestigious school for sorcerers, where teachers and students unite to master curses and protect humanity. Discover ancient techniques, rigorous training, and a vibrant community defending against malevolent forces.",
          price: 88,
        },
        //14
        {
          ownerId: 26,
          address: "15 Sorcery Ave",
          city: "Kyoto",
          ...
          description:
            "Renowned institution of jujutsu sorcery, known for its fierce competitions and formidable students. Prepare for intense battles, intricate techniques, and a rich history of exorcism traditions.",
          price: 88,
        },
        //15
        {
          ownerId: 27,
          address: "6 Mystic Street",
          city: "Tokyo",
          state: "Tokyo Prefecture",
          country: "Japan",
          lat: null,
          ...
          name: "Unlimited Void",
          description:
            "A forbidden and enigmatic domain controlled by Satoru Gojo, the Six Eyes. Step into the Limitless, a vast void of infinite knowledge. A realm where infinite power and mysteries collide, surrounded by an overwhelming aura of Cursed Energy.",
          price: 600,
        },
        // 16
        {
          ...
          lng: null,
          description:
            "A treacherous and malevolent domain ruled by Ryomen Sukuna, the King of Curses. Enter at your own peril, where darkness and fear lurk around every corner, testing the limits of your resolve.",
          price: 1000,
        },
      ],
      {}
